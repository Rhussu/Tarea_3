...
public class PanelBilletera extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g.fillRect(0,80,150,(int) Ventana.frame().windowSize().getHeight() -80);
        ...
        try {
            ...
            for(int i = 0; i < 6; i++) {
                ...
                g.drawImage(image[i],distanciaAlBordeIzquierdo,frameX()*i,null);
            }
        } catch (Exception e) {
    ...
    private int frameX() {
        return (int) ((Ventana.frame().windowSize().getHeight())/6.2);
    }
}
